...
def load_config(path: str | Path | None = None) -> dict:
    ...
    Always returns a deep copy — nested DEFAULTS dicts (e.g. "whisper")
    must never be shared with the caller, or an in-place mutation on one
    loaded config leaks into every subsequent load_config() call in the
    process (DEFAULTS is a module-level singleton).
    """
